do
  ...
  -- zf only works when 'foldmethod' is "manual" or "marker" — the Tree-sitter
  -- "expr" method from options.lua rejects it with E350. Switch this window to
  -- manual first. Tree-sitter folds in this window are dropped in exchange.
