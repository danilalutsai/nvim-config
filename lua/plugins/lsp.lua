...
local servers = {
  ...
  -- Tailwind class completion, hover previews, and colour swatches.
  -- Tailwind v4 has no tailwind.config.js — the server locates a project
  -- through the CSS entry point containing `@import "tailwindcss"`, so
  -- package.json/.git are what actually match for v4 projects.
  tailwindcss = {
