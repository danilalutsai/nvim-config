...
-- - selection #3392FF44
-- - cursor #c8e1ff
-- - line highlight #2b3036
--
-- Syntax
--
-- - comments #6a737d
-- - keywords, storage, operators #f97583
-- - strings #9ecbff
-- - functions, method names #b392f0
-- - constants, numbers, booleans #79b8ff
-- - variables, parameters #ffab70
-- - types, classes, entity names #79b8ff
-- - HTML/JSX tags #85e89d
-- - attributes #b392f0
-- - regex #85e89d
...
require('catppuccin').setup {
  ...
  custom_highlights = function(colors)
    ...
    return {
      ...
      ['MatchParen'] = { fg = "#ffab70", bg = "#131424", bold = true },
